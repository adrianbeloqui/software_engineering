"""
Solutions to "Binary to String" problem from Github.

Copied here to understand the code
"""
...
if __name__ == "__main__":
    # example()
    bit_str = bin_to_string(0.2)
    response = bit_str if len(bit_str) <= 33 else "ERROR"
    print(f"Number: {1}, Binary String: {response}")
